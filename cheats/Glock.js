 ...
 * https://github.com/ghoulxx/trapping-cheats/blob/main/cheats/Glock.js * This program is distributed in the hope that it will be useful,
...
(() => {
    ...
    const cheat = (async () => {
        ...
        credit.innerText = "Created by trapping";
        ...
        version.innerText = "trapping - blooket " + versionName;
